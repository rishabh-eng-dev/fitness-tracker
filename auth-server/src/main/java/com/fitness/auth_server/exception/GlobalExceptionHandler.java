package com.fitness.auth_server.exception;
...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleBadCredentialsException(BadCredentialsException exception) {
        ProblemDetail errorDetail = ProblemDetail.forStatus(HttpStatus.UNAUTHORIZED);
        errorDetail.setTitle("Authentication Failed");
        errorDetail.setDetail("Incorrect username or password provided.");
        return errorDetail;
    }
    ...
    public ProblemDetail handleAccountStatusException(AccountStatusException exception) {
        ...
        errorDetail.setTitle("Account Locked/Disabled");
        errorDetail.setDetail("User account is locked or disabled.");
        return errorDetail;
    }
